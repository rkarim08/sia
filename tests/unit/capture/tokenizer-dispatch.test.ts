...
import { loadTokenizerByModelName, loadTokenizerForModel } from "@/capture/tokenizer-dispatch";
...
describe("tokenizer dispatch", () => {
	...
	it("loadTokenizerByModelName uses registry tokenizerType", () => {
		...
		expect(() =>
			loadTokenizerByModelName("jina-embeddings-v2-base-code", "/nonexistent/tok.json"),
		).toThrow();
	});
});
