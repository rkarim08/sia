...
import { fetchEntities, fetchFile } from "../lib/api";
import type { SiaNodeType } from "../lib/constants";
import { BG_PANEL, NODE_COLORS } from "../lib/constants";
	...
	return (
		...
		>
			...
			<div style={{ flex: 1, overflow: "auto" }}>
				...
				{error && <div style={{ padding: 16, color: "#ef5350", fontSize: 12 }}>{error}</div>}
