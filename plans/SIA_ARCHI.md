...
-- Issue #21: sync_dedup_log and the nightly consolidation sweep
-- serve different purposes and must not share a table.
-- ─────────────────────────────────────────────────────────────────

-- local_dedup_log: tracks entity pairs checked during the nightly
...
Results written to `sync_dedup_log` (separate from `local_dedup_log` used by the nightly consolidation sweep):
